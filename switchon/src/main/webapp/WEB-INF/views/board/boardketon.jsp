  ...
  <div class="container-fluid">
    <div class="row p-3" style="height: 90vh;">
      ...
      <div class="col col-10">
        <div class="border bg-primary bg-opacity-10 h-100 rounded-5 d-flex flex-column justify-content-center align-items-center	">
        	<p class="text-center fw-bold text-black bg-outline-secondary py-2 px-4 rounded" style="font-size: 1.5rem;">
				저탄수 도시락 추천목록
			</p>
        	<table class="table table-hover table-bordered text-center align-middle" style="width: 80%; max-width: 1200px;">
			    ...
			    <tbody>
			        <c:forEach var="keton" items="${ketonList}">
			            <tr>
			                <td>${keton.rankNum}</td>
			                <td>${keton.ketonName}</td>
			                <td>${keton.ketonPrice}원</td>
			                <td>
			                    <a href="https://smartstore.naver.com${keton.ketonUrl}" class="btn btn-outline-primary" target="_blank">
			                        	상품 보기
			                    </a>
			                </td>
			            </tr>
